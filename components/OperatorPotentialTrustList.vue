...
import { ALTERNATE_ATTRIBUTE_NAMES, getPotentialBadgeUrl } from "~/utils"
    ...
    <ul class="flex flex-col gap-1 text-sm">
      <li>
        ...
        >
          ...
          >
            <img
              :src="getPotentialBadgeUrl(0, 'small')"
            />
          </div>
        ...
        >
          ...
          >
            <img
              ...
              :src="getPotentialBadgeUrl(potential.potentialNumber - 1, 'small')"
            />
          </div>
          <div>
